  ...
  return (
    <MainLayout>
      <div className="min-h-screen bg-slate-950 text-white">
        {/* 🚀 메인 콘텐츠 영역 */}
        <main className="mx-auto w-full max-w-7xl px-6 py-12 lg:py-10 animate-in fade-in duration-1000">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-12">
            ...
            <div className="relative group">
              <button 
                ...
                className="w-full aspect-[16/9] lg:aspect-[4/3] rounded-[2rem] border-2 border-dashed border-white/10 bg-white/5 flex flex-col items-center justify-center gap-6 transition-all duration-500 hover:border-primary-deep/50 hover:bg-white/[0.07] group-hover:shadow-[0_0_50px_-12px_rgba(59,130,246,0.3)]"
              >
          ...
          {/* ➡️ 오른쪽: SERVICE FLOW */}
          <div className="space-y-10 lg:pl-10 animate-in slide-in-from-right-4 duration-1000 delay-300">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-black text-blue-500 uppercase tracking-[0.2em]">Service Flow</h2>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.step} className="group relative rounded-3xl border border-white/5 bg-white/[0.03] p-6 transition-all hover:bg-white/[0.06] hover:border-white/10">
